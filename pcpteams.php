...
function pcpteams_civicrm_navigationMenu(&$params){
  ...
  if(isset($result['state']) && in_array('individual', $result['state'])){
    //My Dashboard
  ...
  if(isset($result['state']) && in_array('team', $result['state'])){
    //TEAM Dashboard
  ...
  if(isset($result['state']) && in_array('group', $result['state'])){
    //Group Dashboard
  ...
  if(isset($result['state']) && in_array('tribute', $result['state'])){
    //Tribute Dashboard
