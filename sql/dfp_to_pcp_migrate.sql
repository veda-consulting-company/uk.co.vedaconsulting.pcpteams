...
SELECT @event_title      := 'London Bikeathon 2015';
...
SELECT @pcp_block_id := SELECT pb.id FROM civicrm_pcp_block pb WHERE  pb.entity_table = 'civicrm_event' and pb.entity_id = @event_id;
