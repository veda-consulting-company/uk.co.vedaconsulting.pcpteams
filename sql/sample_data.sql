...
('civicrm_event', @event_id, 'contribute', @contrib_page_id, @supporter_profile_id, 0, 1, 5, 'Promote this donation with a personal campaign page', 1, 'deepak@vedaconsulting.co.uk');
...
SELECT @relationship_type_id := id FROM civicrm_relationship_type WHERE name_a_b = 'Team Member of';
