...
<div class="crm-form-block crm-search-form-block">
        ...
        <span class="bold">{ts}Start typing the name
            ...
            team page and join from there or you could create your own team by clicking the <a class='crm-button' href='{$redirectUrlCreate}'>{ts}Create New Team{/ts}</a> button or you could email <a href="https://leukaemialymphomaresearch.org.uk/">{ts}LLR{/ts}</a>{/ts}</span>
