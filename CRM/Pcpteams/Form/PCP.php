 ...
 *
 */
class CRM_Pcpteams_Form_PCP extends CRM_Core_Form {
  public $_context;
  public $_component;
  ...
  public function preProcess() {
    ...
    $this->_component = $this->controller->get('pcpComponent');
    ...
    //pcp-id we 'll have to figure out from contact
    //$this->_pageId = CRM_Utils_Request::retrieve('id', 'Positive', $this, FALSE);
    $this->_pageId = CRM_Core_DAO::getFieldValue('CRM_PCP_DAO_PCP', $contactID, 'id', 'contact_id');
